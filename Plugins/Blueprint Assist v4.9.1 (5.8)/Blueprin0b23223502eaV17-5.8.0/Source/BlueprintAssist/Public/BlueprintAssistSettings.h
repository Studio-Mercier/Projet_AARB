...
public:
	...
	/* Disable helixing if the number of linked pins is >= than this number */
	...
	/* Should `DisableHelixingPinCount` only count linked parameters pins */
	UPROPERTY(EditAnywhere, config, Category = FormattingOptions, meta = (EditCondition = "bDisableHelixingWithMultiplePins"))
	bool bDisableHelixingOnlyCountsParameters;
