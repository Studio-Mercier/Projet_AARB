...
public:
	...
	/* Save the cached node size into UEdGraphNode NodeWidth and NodeHeight */
	UPROPERTY(EditAnywhere, config, Category = "Cache")
	bool bWriteSizeToEdGraphNode;
	...
	/* Immediately show size caching overlay on blueprint graphs to avoid flicker */
	UPROPERTY(EditAnywhere, config, Category = "Misc|Experimental")
	bool bImmediatelyShowGraphOverlay;
